  ...
  return (
    <button
      ...
      className={`
        ...
        bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-light shadow-lg hover:shadow-blue-500/50
        active:motion-scale-in-[0.8] active:motion-blur-in-[2px] active:motion-duration-[1.5s]/scale active:motion-duration-[1.5]/blur
